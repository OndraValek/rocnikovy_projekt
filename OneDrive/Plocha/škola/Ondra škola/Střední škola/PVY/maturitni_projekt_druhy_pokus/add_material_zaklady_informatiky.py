"""
Skript pro přidání materiálu "Základy informatiky" do databáze.
"""
import os
import django
...
print("=" * 70)
print("PIDÁNÍ MATERIÁLU 'ZÁKLADY INFORMATIKY'")
print("=" * 70)
print()
...
if created:
    ...
    print(f"✓ Použit existující předmět: {subject.name}")
...
if created:
    print(f"✓ Vytvořen okruh: {topic.name}")
else:
    print(f"✓ Použit existující okruh: {topic.name}")
...
if created:
    print(f"✓ Vytvořen materiál: {material.title}")
else:
    ...
    material.order = 1
    material.save()
    print(f"✓ Aktualizován materiál: {material.title}")

print()
print("=" * 70)
print("✓ Hotovo! Materiál byl úspěšně přidán/aktualizován.")
print()
print(f"Předmět: {subject.name}")
print(f"Okruh: {topic.name}")
print(f"Materiál: {material.title}")
print(f"Typ: {material.get_material_type_display()}")
print(f"URL: /materials/{material.id}/")
print("=" * 70)
